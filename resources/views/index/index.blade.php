...
<head>
  ...
  <!-- ** Basic Page Needs ** -->
  <meta charset="utf-8">
  <title>Phantom - PMR Slovenija</title>
...
<main class="site-wrapper">
  <div class="pt-table">
    <div class="pt-tablecell page-home relative" style="background-image: url('images/alps.jpg');">
        ...
        <div class="row">
          <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
            <div class="page-title home text-center">
              <img src="images/g91.png" alt="">
              <p>A product designed for PMR Slovenija group. It specialises in contact logging, spotting, event viewing and much more!</p>
                <p>Please select a tool to start.</p>
            </div>
            ...
            <div class="hexagon-menu clear">
              ...
              <div class="hexagon-item">
                ...
                <a href="/" class="hex-content">
                  <span class="hex-content-inner">
                    ...
                    <span class="title">Tool area</span>
                  </span>
                  <svg viewbox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path>
                ...
                <div class="hexagon-item">
                    ...
                    <a href="https://sdr1.pmr.si/#freq=446168750,mod=nfm,sql=-55" target="_blank" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i class="tf-dial"></i>
                    </span>
                    <span class="title">OpenWebRX+</span>
                  </span>
                        <svg viewbox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                             xmlns="http://www.w3.org/2000/svg">
                            <path
              ...
              <div class="hexagon-item">
                ...
                <a href="https://slo-tech.com/forum/t796344/0" target="_blank" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i class="tf-tools"></i>
                    </span>
                    <span class="title">Slotech forum</span>
                  </span>
                  <svg viewbox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path>
              ...
              <div class="hexagon-item">
                ...
                <div class="hex-item">
                  ...
                  <a href="https://discord.gg/uJwU4dH3hF" target="_blank" class="hex-content">
                    <span class="hex-content-inner">
                         <span class="icon">
              ...
              <div class="hexagon-item">
                ...
                <a href="https://www.facebook.com/groups/355467710574815" target="_blank" class="hex-content">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i class="tf-chat"></i>
                    </span>
