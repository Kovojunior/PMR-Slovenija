          ...
          <div class="row">
            <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
              <div class="page-title text-center">
                ...
                <p>Feel free to reach out! Whether you have a question, feedback, or just want to say hello, I’d love to hear from you.
                    Simply fill out the form, and I’ll get back to you as soon as possible. Let's stay connected!</p>
              </div>
            </div>
          </div> <!-- /.row -->
            ...
            <div class="col-xs-12 col-sm-5 col-md-4 col-lg-3">
              <div class="contact-block">
                <div class="media">
                  ...
                  <div class="media-body">
                    <h4>Email</h4>
                    <p><a href="mailto:zigakovac42@gmail.com">zigakovac42@gmail.com</a></p>
                  </div>
                </div>
              </div>
              <!-- /.contact-block -->
              <div class="contact-block">
                <div class="media">
                  ...
                  <div class="media-body">
                    <h4>Phone</h4>
                    <p><a href="tel:+386-4152-4016">041-524-016</a></p>
                  </div>
                </div>
              </div>
                <!-- /.contact-block -->
                <div class="contact-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>Discord</h4>
                            <p><a href="https://discordapp.com/users/ziggy42">Ziggy42</a></p>
                        </div>
                    </div>
                </div>
                <!-- /.contact-block -->
                ...
                <form id="contact-form" class="row contact-form no-gutter" action="/contact" method="post">
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="input-field message">
                            ...
                            <textarea name="message" id="message" class="form-control" placeholder="Write your message" required></textarea>
                        </div>
                    </div> <!-- ./col- -->
                    <div class="col-xs-12 col-sm-12">
                        <div class="input-field">
        ...
        <nav class="page-nav clear">
          <div class="container">
            <div class="flex flex-middle space-between">
              ...
              <span class="copyright">Copyright &copy; 2024, Designed &amp; Developed by <a href="https://themefisher.com/">Themefisher</a>, redesigned by Žiga Kovač.</span>
            </div>
          </div>
          <!-- /.page-nav -->
        </nav>
