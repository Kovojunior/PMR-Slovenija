        ...
        <div class="row">
            ...
            <div class="col-xs-3">
                                ...
                                <div class="panel-group" id="filter-menu-mobile" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="panel panel-mobile">
                                        ...
                                        <div id="collapseFiveMobile" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFiveMobile">
                                            <div class="panel-body">
                                                ...
                                                <div class="checkbox"><label><input type="checkbox" name="spot_type[]" value="alert">Alert</label></div>
                                    ...
                                    <div class="panel panel-mobile">
                                        ...
                                        <div id="collapseTwoMobile" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwoMobile">
                                            <div class="panel-body">
                                                <div class="checkbox"><label><input type="checkbox" name="callsign[]" value="inactive">Show inactive</label></div>
                ...
                <div>
                    ...
                    <div>
                        <small id="spot-count">Showing {{$total}} User locations, alerts and spots</small> <small class="text-primary font-weight-bold"></small>
                    </div>
                    <div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function showOnMap(spots) {
            ...
            spots.forEach(function (spot) {
                ...
                if (isSpotActive(spot) || showInactive || spot.time === "alert") {
                    ...
                    console.log('Spot is no longer active and checkbox is not checked:', spot);
                }
            });
        }
        ...
        function updateSpotCount(count) {
            document.getElementById('spot-count').innerHTML = `Showing ${count} User locations, alerts and spots`;
        }
