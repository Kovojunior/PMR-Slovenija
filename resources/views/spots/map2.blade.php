...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/css/spots_map.css') }}" type="text/css">
...
<div id="wrapper">
    ...
    @include('layouts.sidebar_filter_spots')
    <!-- End of Sidebar -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <!-- Begin Page Content -->
            {{--                    {{ dd($listings->map(function ($listing) { return $listing->attributesToArray(); })->all()) }}--}}
...
<script src="{{ asset('/js/spots_map.js') }}"></script>
